...
- 🌐 **دوزبانه** — فارسی و انگلیسی؛ کاربر از تنظیمات زبانش را عوض می‌کند (پیش‌فرض فارسی)
...
- **v2.1.0** — بک‌اند پنل وب (API کامل تسک‌ها و پروفایل)، ورود OTP با کدی که بات می‌فرستد، نشست لغزان ۳۰ روزه، ویرایش پروفایل از بات، بات دوزبانه (فارسی/انگلیسی)، سیستم لاگ ساخت‌یافته
